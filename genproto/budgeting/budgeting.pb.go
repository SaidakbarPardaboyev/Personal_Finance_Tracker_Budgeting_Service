...
var file_budgeting_proto_rawDesc = []byte{
	...
	0x6f, 0x12, 0x09, 0x62, 0x75, 0x64, 0x67, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x22, 0x1c, 0x0a, 0x0a,
	...
	0x69, 0x64, 0x42, 0x16, 0x5a, 0x14, 0x2e, 0x2f, 0x67, 0x65, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x2f, 0x62, 0x75, 0x64, 0x67, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_budgeting_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_budgeting_proto_goTypes = []interface{}{
	(*PrimaryKey)(nil), // 0: budgeting.PrimaryKey
	(*Void)(nil),       // 1: budgeting.Void
}
...
func file_budgeting_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_budgeting_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_budgeting_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Void); i {
			case 0:
				return &v.state
			case 1:
