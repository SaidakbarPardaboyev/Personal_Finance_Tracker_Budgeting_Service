...
var file_users_service_proto_rawDesc = []byte{
	...
	0x6c, 0x65, 0x32, 0xe4, 0x02, 0x0a, 0x0c, 0x55, 0x73, 0x65, 0x72, 0x73, 0x53, 0x65, 0x72, 0x76,
	...
	0x56, 0x6f, 0x69, 0x64, 0x12, 0x33, 0x0a, 0x11, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x55, 0x73, 0x65,
	0x72, 0x49, 0x64, 0x45, 0x78, 0x69, 0x73, 0x74, 0x73, 0x12, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72,
...
var file_users_service_proto_depIdxs = []int32{
	...
	7, // 7: users.UsersService.CheckUserIdExists:input_type -> users.PrimaryKey
	6, // 8: users.UsersService.GetById:output_type -> users.user
	1, // 9: users.UsersService.GetAll:output_type -> users.users
	3, // 10: users.UsersService.Update:output_type -> users.UpdatedUser
	8, // 11: users.UsersService.Delete:output_type -> users.Void
	8, // 12: users.UsersService.ChangePassword:output_type -> users.Void
	8, // 13: users.UsersService.ChangeUserRole:output_type -> users.Void
	8, // 14: users.UsersService.CheckUserIdExists:output_type -> users.Void
